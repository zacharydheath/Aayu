...
const fullContent: Record<string, { body: string[] }> = {
  'south-asian-heart-disease-risk': {
    body: [
      'The statistics are not subtle. Bangladeshis develop cardiovascular disease at rates four times higher than the general Western population — and at ages that routinely catch both patients and physicians off guard. A 45-year-old Bangladeshi man presenting with his first cardiac event is not unusual. A 50-year-old Bangladeshi woman with advanced coronary artery disease who has never smoked, is not overweight by standard measures, and has a clean cholesterol panel is not unusual either.',
      'The question is why — and more importantly, what to do about it.',
      'Part of the answer lies in the inadequacy of the tools we use to assess cardiovascular risk in Bangladeshi populations. Standard BMI thresholds, developed from studies conducted predominantly on white Western populations, consistently miss the visceral fat accumulation that characterises Bangladeshi metabolic profiles. Bangladeshis tend to carry more dangerous abdominal fat at lower overall body weights. A BMI of 23 in a Bangladeshi individual may carry the same metabolic risk as a BMI of 27 in a white European.',
      'The cholesterol picture is similarly misleading. Standard lipid panels miss the elevated lipoprotein(a) that runs at higher rates in Bangladeshi populations — a particle that dramatically increases cardiac risk and does not respond to the interventions that lower standard LDL. Many Bangladeshis who appear to have "good" cholesterol are unknowingly carrying a significant additional risk factor that their doctors have never checked for.',
      'Insulin resistance is the third piece. Type 2 diabetes develops at lower BMI thresholds in Bangladeshi populations and often progresses silently for years before diagnosis. The metabolic dysfunction that precedes a diabetes diagnosis — elevated fasting insulin, impaired glucose tolerance, rising triglycerides — is exactly the same dysfunction that drives cardiovascular disease. Catching it early requires testing that most general practitioners don\'t order by default.',
      'None of this is an indictment of any individual doctor. It is a structural problem in a medical system that was not built to recognise the specific risks of Bangladeshi biology. The solution is not to wait for that system to change. The solution is to know what to ask for.',
      'The Aayu biomarker protocol includes lipoprotein(a) testing, fasting insulin alongside standard blood glucose, CIMT (carotid intima-media thickness) assessment where appropriate, and a full vitamin D panel. These are not exotic interventions. They are available at most standard labs. They are simply never ordered, because the default protocol was not designed with Bangladeshi patients in mind.',
